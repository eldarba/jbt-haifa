...
/**
 * Demonstrates, (i) class is NOT loaded on accessing a compile-time constant.
 * Constant is fetched from .class file (ii) On accessing a non compile-time
 * constant, class & its super-class are LOADED and INITIALIZED (iii) On
 * instantiating the class, it is loaded from memory (loading was done previous
 * step) and (a) superclass constructor is run, i.e., CONSTRUCTOR CHAINING (b)
 * its instance variables are initialized and instance initializer block is run
